...
fn benchmark_aoc_day_one(c: &mut Criterion) {
    ...
    group.bench_function("d1s1", |b| b.iter(|| day_one.part_one()));
    group.bench_function("d1s2", |b| b.iter(|| day_one.part_two()));
    group.finish();
}
...
fn benchmark_aoc_day_two(c: &mut Criterion) {
    ...
    group.bench_function("d2s1", |b| b.iter(|| day_two.part_one()));
    group.bench_function("d2s2", |b| b.iter(|| day_two.part_two()));
    group.finish();
}
...
fn benchmark_aoc_day_three(c: &mut Criterion) {
    ...
    group.bench_function("d3s1", |b| b.iter(|| day_three.part_one()));
    group.bench_function("d3s2", |b| b.iter(|| day_three.part_two()));
    group.finish();
}
...
fn benchmark_aoc_day_four(c: &mut Criterion) {
    ...
    group.bench_function("d4s1", |b| b.iter(|| day_four.part_one()));
    group.bench_function("d4s2", |b| b.iter(|| day_four.part_two()));
    group.finish();
}
...
fn benchmark_aoc_day_five(c: &mut Criterion) {
    ...
    group.bench_function("d5s1", |b| b.iter(|| day_five.part_one()));
    group.bench_function("d5s2", |b| b.iter(|| day_five.part_two()));
    group.finish();
}
...
fn benchmark_aoc_day_six(c: &mut Criterion) {
    ...
    group.bench_function("d6s1", |b| b.iter(|| day_six.part_one()));
    group.bench_function("d6s2", |b| b.iter(|| day_six.part_two()));
    group.finish();
}
...
fn benchmark_aoc_day_seven(c: &mut Criterion) {
    ...
    group.bench_function("d7s1", |b| b.iter(|| day_seven.part_one()));
    group.bench_function("d7s2", |b| b.iter(|| day_seven.part_two()));
    group.finish();
}
...
fn benchmark_aoc_day_eight(c: &mut Criterion) {
    ...
    group.bench_function("d8s1", |b| b.iter(|| day_eight.part_one()));
    group.bench_function("d8s2", |b| b.iter(|| day_eight.part_two()));
    group.finish();
}
